...
c
            ...
            if (info .eq. 1) go to 300
            if (info .ne. 0 .and. iter .gt. maxiter) then
c              print *, "failed info test, info=",info,iter,
c    &          delta,xtol,xnorm,fnorm
               go to 300
            end if
c
...
c           if (info .ne. 0) go to 300
c           if (info .ne. 0 .and. iter .gt. maxiter) then
c              print*,"failed termination/tol test, info=",info,iter
c              go to 300
c           end if
c
