subroutine output_Ca (pt,sdl,mtal,ctal,dct,cnt,ccd,omcd,imcd)
...
!     cellular profiles
      ...
      do j = 1,NZ
        ...
        write(24,200), j*dx,pt(j)%conc(16,6)
        write(44,200), j*dx,pt(j)%conc(16,1)
        write(64,200), j*dx,pt(j)%conc(16,2)
        ...
        write(84,200), j*dx,pt(j)%vol(1)*pt(j)%conc(16,1)*cw
      end do
      ...
      do j = 1,NZ
        ...
        write(24,200), pos,sdl(j)%conc(16,6)
        write(44,200), pos,sdl(j)%conc(16,1)
        write(64,200), pos,sdl(j)%conc(16,2)
        ...
        write(84,200), pos,sdl(j)%vol(1)*sdl(j)%conc(16,1)*cw
      end do
      ...
      do j = 0,NZ
        ...
        write(24,200), pos,mtal(j)%conc(16,6)
        write(44,200), pos,mtal(j)%conc(16,1)
        write(64,200), pos,mtal(j)%conc(16,2)
        ...
        write(84,200), pos,mtal(j)%vol(1)*mtal(j)%conc(16,1)*cw
      end do
      ...
      do j = 1,NZ
        ...
        write(24,200), pos,ctal(j)%conc(16,6)
        write(44,200), pos,ctal(j)%conc(16,1)
        write(64,200), pos,ctal(j)%conc(16,2)
        ...
        write(84,200), pos,ctal(j)%vol(1)*ctal(j)%conc(16,1)*cw
      end do
      ...
      do j = 1,NZ
        ...
        write(24,200), pos,dct(j)%conc(16,6)
        write(44,200), pos,dct(j)%conc(16,1)
        write(64,200), pos,dct(j)%conc(16,2)
        ...
        write(84,200), pos,dct(j)%vol(1)*dct(j)%conc(16,1)*cw
      end do
      ...
      do j = 1,NZ
        ...
        write(24,200), pos,cnt(j)%conc(16,6)
        write(44,200), pos,cnt(j)%conc(16,1)
        write(64,200), pos,cnt(j)%conc(16,2)
        ...
        write(84,200), pos,cnt(j)%vol(1)*cnt(j)%conc(16,1)*cw
     end do
      ...
      do j = 1,NZ
        ...
        write(24,200), pos,ccd(j)%conc(16,6)
        write(44,200), pos,ccd(j)%conc(16,1)
        write(64,200), pos,ccd(j)%conc(16,2)
        ...
        write(84,200), pos,ccd(j)%vol(1)*ccd(j)%conc(16,1)*cw
      end do
      ...
      do j = 1,NZ
        ...
        write(24,200), pos,omcd(j)%conc(16,6)
        write(44,200), pos,omcd(j)%conc(16,1)
        write(64,200), pos,omcd(j)%conc(16,2)
        ...
        write(84,200), pos,omcd(j)%vol(1)*omcd(j)%conc(16,1)*cw
      end do
      ...
      do j = 1,NZIMC
        ...
        write(24,200), pos,imcd(j)%conc(16,6)
        write(44,200), pos,imcd(j)%conc(16,1)
        write(64,200), pos,imcd(j)%conc(16,2)
        ...
        write(84,200), pos,imcd(j)%vol(1)*imcd(j)%conc(16,1)*cw
